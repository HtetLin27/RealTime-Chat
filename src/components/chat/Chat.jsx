  ...
  return (
    <div className='chat'>
      ...
      <div className="bottom">
        ...
        <input value={text} onChange={(e)=>setText(e.target.value)} type="text" placeholder={(isCurrentUserBlocked || isReceiverBlocked) ? "You cannot send a message" : "Type a message.."} disabled={isCurrentUserBlocked || isReceiverBlocked} />
        <div className="emoji">
